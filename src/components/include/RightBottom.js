...
const RightBottom = () => {
    return (
        <section id="hot_product" className="hot_product w-full h-[73%] rounded-[20px] overflow-hidden shadow-lg bg-[#FAFAFA]">
            <div className="px-6 py-4">
                <div className="font-bold text-xl mb-2">인기 상품</div>
